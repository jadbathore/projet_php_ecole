...
//vous remarquera que certaine sont 0 et d'autre son des arrays cela et suporter grace a une methode qui identifie chaque cas de figure et procedes en fonction.
...
// vous remarquerait que eleveManager n'est pas d'embler tester en faite le test final comprend la method testing qui va tester toute les methods si elle son bonne et si elle ne son pas vide , mais si je ne remplit pas la base de 
// donné au préalable il y aura toujour une erreur c'est pour cela que le test à la fin .pour tester les erreur vous pouvez essayer en vidant les table (eleves,joint_table_all et stat) puis  de mettre en commentaire les 
// ligne 44($eleveManager->addEleve($eleve);), 
// 57($statManager->addStat($stat);), 
// 69($descrManager->addDescr($descr);) 
